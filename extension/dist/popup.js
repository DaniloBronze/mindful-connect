...
class AuthImpl {
    ...
    async _getAppCheckToken() {
        var _a;
        if (index_esm2017_isFirebaseServerApp(this.app) && this.app.settings.appCheckToken) {
 ...
 * limitations under the License.
 */
const index_e84cf44d_DB_NAME = 'firebaseLocalStorageDb';
const index_e84cf44d_DB_VERSION = 1;
...
function _deleteDatabase() {
    const request = indexedDB.deleteDatabase(index_e84cf44d_DB_NAME);
    return new DBPromise(request).toPromise();
}
function _openDatabase() {
    const request = indexedDB.open(index_e84cf44d_DB_NAME, index_e84cf44d_DB_VERSION);
    return new Promise((resolve, reject) => {
...
var index_e84cf44d_name = "@firebase/auth";
var index_e84cf44d_version = "1.9.1";
...
function registerAuth(clientPlatform) {
    ...
    registerVersion(index_e84cf44d_name, index_e84cf44d_version, getVersionForPlatform(clientPlatform));
    // BUILD_TARGET will be replaced by values like esm2017, cjs2017, etc during the compilation
    registerVersion(index_e84cf44d_name, index_e84cf44d_version, 'esm2017');
}
...
const firebaseConfig = {
  apiKey: "AIzaSyBQZNSZSqT_aSR6jYZZt5faRl8g3qEg_Hs",
  authDomain: "mindfull-993d8.firebaseapp.com",
  projectId: "mindfull-993d8",
  storageBucket: "mindfull-993d8.appspot.com",
  messagingSenderId: "1098122383196",
  appId: "1:1098122383196:web:a0a0f6a4c8c2e8b8b8b8b8"
};
...
async function firebase_auth_signOut() {
  try {
    const {
      authToken
    } = await chrome.storage.local.get('authToken');
